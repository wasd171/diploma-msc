...
\definecolor{codecomment}{RGB}{8, 132, 8}
\definecolor{codegray}{rgb}{0.5,0.5,0.5}
\definecolor{codestring}{RGB}{163, 21, 21}
\definecolor{codekeyword}{RGB}{194, 59, 227}
\definecolor{codeemph}{RGB}{13, 13, 255}

\lstdefinelanguage{n2EDMScript}{
  keywords={IF, THEN, ELSE, ENDIF, FOR, DO, DONE, SET, REQUEST, ADDLINE, INSERTLINE, REPLACELINE, DELETELINE, LABEL, GOTO, SLEEP, RESUME, PAUSE},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
...
\lstdefinelanguage{JavaScript}{
  ...
  emph={const, let, var, true, false, null},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
