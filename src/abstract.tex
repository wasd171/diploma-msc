\begin{abstract}
  ...
  \begin{itemize}
  	...
  	\item \textbf{Surrounding field compensation system} --- a system for active stabilisation of the magnetic field. It uses the a set of controlled coils to minimise the fluctuations of the magnetic field in the area of the experiment.
  \end{itemize}
  ...
  Check the source at \url{https://github.com/wasd171/diploma-msc}
